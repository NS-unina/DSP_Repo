...
echo mysql -uroot -e "CREATE USER 'dsp'@'%' IDENTIFIED BY '$PASS'"
echo mysql -uroot -e "GRANT ALL PRIVILEGES ON *.* TO 'dsp'@'%' WITH GRANT OPTION"
echo mysql -uroot -e " GRANT ALL PRIVILEGES ON phpmyadmin.* TO  'pma'@'localhost' IDENTIFIED BY '$PASS'"


mysql -uroot -e "CREATE USER 'dsp'@'%' IDENTIFIED BY '$PASS'"
mysql -uroot -e "GRANT ALL PRIVILEGES ON *.* TO 'dsp'@'%' WITH GRANT OPTION"

mysql -uroot -e " GRANT ALL PRIVILEGES ON phpmyadmin.* TO  'pma'@'localhost' IDENTIFIED BY '$PASS'"
